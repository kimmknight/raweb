...
Enabling this policy strips the signature, allowing users to safely edit the downloaded `.rdp` file before connecting, at the cost of displaying an "Unknown Publisher" warning when connecting.
