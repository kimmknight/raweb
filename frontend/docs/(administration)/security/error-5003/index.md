...
If you are seeing a ERR_SSL_KEY_USAGE_INCOMPATIBLE error in your web browser, you may need to generate a new certificate with correct key usage (see [#35](https://github.com/kimmknight/raweb/issues/35)). You may also see this error if a different IIS web site has an HTTPS binding that captures all "All Unassigned" IP addresses (see [#276 (comment)](https://github.com/kimmknight/raweb/issues/276#issuecomment-5008242513)).
