...
If a newer version of RAWeb is available, RAWeb will display a notice in the top-right corner of the titlebar. Click the notice to view the release notes for the latest version, which usually includes installation instructions.
...
<img src="./update-available.webp" alt="Screenshot showing the update available notice" class="screenshot" width="800">
