...
You may be able to enable NTLM authentication with nginx via nginx plus or by using [nginx-ntlm-module](https://github.com/gabihodoroaga/nginx-ntlm-module).
