<script setup lang="ts">
  import { SelectorBar, SelectorBarButton } from '$components';
...
<template>
  <SelectorBar v-if="shouldShowNavBar" class="settings-nav" :class="{ hidden, simpleModeEnabled }">
    <RouterLink to="/settings" custom v-slot="{ href, isExactActive, navigate }">
      <SelectorBarButton :href :selected="isExactActive" @click="navigate">
