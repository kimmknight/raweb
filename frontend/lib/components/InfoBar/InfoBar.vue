...
<template>
  <div :class="['info-bar', `severity-${severity}`]" role="alert" :restProps>
    <div class="info-bar-icon">
      <span class="info-badge severity-information" v-if="severity === 'information'">
        <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="406 64 213 875">
          <path
            fill="currentColor"
      ...
      <span class="info-badge severity-attention" v-if="severity === 'attention'">
        <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="162 118 701 789">
          <path
            fill="currentColor"
      ...
      <span class="info-badge severity-success" v-if="severity === 'success'">
        <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="118 245 790 577">
          <path
            fill="currentColor"
      ...
      <span class="info-badge severity-caution" v-if="severity === 'caution'">
      ...
      <span class="info-badge severity-critical" v-if="severity === 'critical'">
...
<style scoped>
  ...
  .info-bar.severity-success {
    background-color: var(--wui-system-success-background);
  }
  ...
  .info-badge.severity-information {
    background-color: var(--wui-system-solid-neutral);
  }
  .info-badge.severity-attention {
    background-color: var(--wui-system-attention);
  }
  .info-badge.severity-success {
    background-color: var(--wui-system-success);
  }
