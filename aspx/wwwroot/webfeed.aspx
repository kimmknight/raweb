  ...
  if(authUser=="") {
      ...
      foreach (string eachfile in allfiles)
      {
        if (!(GetRDPvalue(eachfile, "full address:s:") == ""))
        {
            ...
            HttpContext.Current.Response.Write("<IconRaw FileType=\"Ico\" FileURL=\"" + Root() + "get-image.aspx?image=" + basefilename + "&amp;format=ico\" />" + "\r\n");
            HttpContext.Current.Response.Write("<Icon32 Dimensions=\"32x32\" FileType=\"Png\" FileURL=\"" + Root() + "get-image.aspx?image=" + basefilename + "&amp;format=png32\" />" + "\r\n");
            HttpContext.Current.Response.Write("</Icons>" + "\r\n");
            if (appftastring != "")
            {
                ...
                foreach(string filetype in appftaarray)
                {
                    ...
                    HttpContext.Current.Response.Write("<IconRaw FileType=\"Ico\" FileURL=\"" + Root() + "get-image.aspx?image=" + docicon + "&amp;format=ico\" />" + "\r\n");
                    HttpContext.Current.Response.Write("</FileAssociationIcons>" + "\r\n");
            ...
            HttpContext.Current.Response.Write("<ResourceFile FileExtension=\".rdp\" URL=\"" + Root() + "resources/" + apprdpfile + "\" />" + "\r\n");
