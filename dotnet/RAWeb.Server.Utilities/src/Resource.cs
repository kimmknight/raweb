...
public class Resource {
  ...
  public string RelativePath {
    get {
      if (Origin == ResourceOrigin.Rdp) {
        Console.WriteLine("Constants.AppDataFolderPath: " + Constants.AppDataFolderPath);
        Console.WriteLine("Rdp source: " + Source.Replace(Constants.AppDataFolderPath, ""));
  ...
  /// <summary>
  /// Sets the GUID for the resource from an existing Guid object.
  /// </summary>
  ...
  /// <summary>
  /// Sets the GUID for the resource from a string representation of a GUID.
  /// If the string is not a valid GUID format, an ArgumentException is thrown.
  /// </summary>
  /// <param name="guidString">A string representation of a Guid.</param>
  /// <returns>Resource</returns>
  /// <exception cref="ArgumentException"></exception>
